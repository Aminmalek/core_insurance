...
class Command(BaseCommand):
    ...
    def create_users(self):
        company_user = User.objects.create_user(username="1234567891", password="123456", first_name="محمد", last_name="محمدی",
                                                phone=9123456789, bank_account_number="520560611828005124784801", type=4, is_active=True, is_superuser=True, is_staff=True)
        ...
        vendor_user = User.objects.create_user(username="1234567892", password="123456", first_name="احمد", last_name="احمدی",
                                               phone=9124578958, bank_account_number="520560611828005124784802", type=1, is_active=True, is_superuser=True, is_staff=True)
        ...
        insured_user = User.objects.create_user(username="1234567894", password="123456", first_name="قاسم", last_name="قاسمی",
                                                phone=9128564789, bank_account_number="520560611828005124784805", type=2, is_active=True, is_superuser=True, is_staff=True)
        ...
        holder_user = User.objects.create_user(username="1234567895", password="123456", first_name="محمود", last_name="محمودی",
                                               phone=9128630215, bank_account_number="520560611828005124784804", type=3, is_active=True, is_superuser=True, is_staff=True)
        ...
        superholder_user = User.objects.create_user(username="1234567893", password="123456", first_name="ناصر", last_name="ناصری",
                                                    phone=912502154, bank_account_number="520560611828005124784803", type=5, is_active=True, is_superuser=True, is_staff=True)
