...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        company_user = User.objects.create(username="1234567891", password="123456", first_name="محمد", last_name="محمدی",
        ...
        vendor_user = User.objects.create(username="1234567892", password="123456", first_name="احمد", last_name="احمدی",
        ...
        insured_user = User.objects.create(username="1234567894", password="123456", first_name="قاسم", last_name="قاسمی",
        ...
        holder_user = User.objects.create(username="1234567895", password="123456", first_name="محمود", last_name="محمودی",
        ...
        superholder_user = User.objects.create(username="1234567893", password="123456", first_name="ناصر", last_name="ناصری",
        ...
        superholder_instance = SuperHolder.objects.create(user=superholder_user)
        superholder_instance.supported_holders.add(holder_user)

        self.stdout.write("SuperHolder created %s" % superholder_instance.user.username)
